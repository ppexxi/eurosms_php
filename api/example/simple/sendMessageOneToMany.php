<?php
/**
 * EuroSMS REST API Example. Send One to Many. | Príklad použitia EuroSMS REST API. Poslať jednu na viac.
 */
...
// optional | nepovinný
$message->schedule_timestamp = '2019-01-01 12:12:00';
...
try {
  ...
  $sentMessages = $eurosms->sendMessage($messages, EuroSms::SEND_METHOD_O2M);
